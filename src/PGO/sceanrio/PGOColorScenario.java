    ...
    public static class ColorReadyScene extends PGOScene {
        ...
        public void handleMousePress(MouseEvent e) {
            ...
            if (e.getSource() != pgo.getCanvas2D()) {
                ...
                int type = -1;
                if (selectedSlider.equals(panelMgr.getHueSlider()))
                    type = 1;
                else if (selectedSlider.equals(panelMgr.getSatSlider()))
                    type = 2;
                else if (selectedSlider.equals(panelMgr.getBriSlider()))
                    type = 3;
        ...
        public void handleChange(ChangeEvent e) {
            ...
            if (panelMgr.getHueSlider().getValueIsAdjusting()) {
                ...
                panelMgr.getImageLabel()
                        .setIcon(new ImageIcon(bImg.getScaledInstance(width, height, Image.SCALE_DEFAULT)));
